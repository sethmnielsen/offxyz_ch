...
if("TRUE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /home/seth/mapping_ws/src/robot_localization)
  set(robot_localization_DEVEL_PREFIX /home/seth/mapping_ws/devel)
  ...
  set(robot_localization_INSTALL_PREFIX /home/seth/mapping_ws/install)
...
if(NOT "/home/seth/mapping_ws/devel/include;/home/seth/mapping_ws/src/robot_localization/include;/usr/include/eigen3 " STREQUAL " ")
  set(robot_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/seth/mapping_ws/devel/include;/home/seth/mapping_ws/src/robot_localization/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/seth/mapping_ws/src/robot_localization/${idir}'.  Ask the maintainer 'Tom Moore <ayrton04@gmail.com>' to fix it.")
    endif()
    _list_append_unique(robot_localization_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "ekf;filter_base;filter_utilities;navsat_transform;ros_filter;ros_filter_utilities;ros_robot_localization_listener;ukf")
...
set(depends "cmake_modules;diagnostic_msgs;diagnostic_updater;eigen_conversions;geographic_msgs;geometry_msgs;message_filters;message_runtime;nav_msgs;roscpp;sensor_msgs;std_msgs;tf2;tf2_geometry_msgs;tf2_ros;xmlrpcpp")

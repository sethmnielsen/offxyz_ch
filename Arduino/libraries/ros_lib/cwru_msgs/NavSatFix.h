#ifndef _ROS_cwru_msgs_NavSatFix_h
#define _ROS_cwru_msgs_NavSatFix_h
...
namespace cwru_msgs
{
  ...
  class NavSatFix : public ros::Msg
  {
    public:
      ...
      _header_type header;
      typedef cwru_msgs::NavSatStatus _status_type;
      _status_type status;
    ...
    const char * getType(){ return "cwru_msgs/NavSatFix"; };

...
public:
    /*  Constructor. You can have multiple simultaneous steppers, all moving
        ...
        \param[in] pins Number of pins to interface to. 1, 2 or 4 are supported.
            1 means a stepper driver (with Step and Direction pins)
            2 means a 2 wire stepper. 4 means a 4 wire stepper.
            Defaults to 4 pins.
        \param[in] pin1 Arduino digital pin number for motor pin 1.
            Defaults to pin 2. For a driver (pins==1), this is the Step input to the driver. Low to high transition means to step
        \param[in] pin2 Arduino digital pin number for motor pin 2.
            Defaults to pin 3. For a driver (pins==1), this is the Direction input the driver. High means forward.
        \param[in] pin3 Arduino digital pin number for motor pin 3.
            Defaults to pin 4.
        \param[in] pin4 Arduino digital pin number for motor pin 4.
            Defaults to pin 5. */
